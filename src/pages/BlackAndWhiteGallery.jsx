...
export default function BlackAndWhiteGallery() {
  ...
  const loadPhotos = async () => {
    try {
      setLoading(true);
      const { data } = await axios.get(`${backendUrl}/api/photos/category/blancoynegro`);
    ...
    <section className="gallery-page">
      ...
      {lightboxIndex !== null && (
        <div className="lightbox-overlay" onClick={closeLightbox}>
          ...
          <img className="lightbox-image" src={photos[lightboxIndex]} alt={`B&W ${lightboxIndex + 1}`} onClick={e => e.stopPropagation()} />
